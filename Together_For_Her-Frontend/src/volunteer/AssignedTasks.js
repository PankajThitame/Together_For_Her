            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    {tasks.filter(t => t.status === "In Progress").map(task => (
                        <div key={task.id} className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl p-6 rounded-[3rem] border border-pink-300/70 dark:border-slate-500/50 shadow-xl relative group hover:border-blue-300 transition-all">
                            ...
                            <div className="flex gap-3">
                                <button className="flex-1 py-3 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-[3rem] font-bold text-slate-600 dark:text-slate-300 text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-colors">
                                    <FaDirections /> Navigate
                                </button>
                                <button className="flex-1 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-[3rem] font-bold text-xs uppercase tracking-widest shadow-lg shadow-blue-500/30 transition-all">
                                    Complete
                                </button>
                            </div>
                        </div>
                ...
                <div className="space-y-6">
                    ...
                    {tasks.filter(t => t.status === "Pending Proof").map(task => (
                        <div key={task.id} className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl p-6 rounded-[3rem] border border-pink-300/70 dark:border-slate-500/50 shadow-xl relative group hover:border-amber-300 transition-all">
                            ...
                            <div className="p-4 bg-amber-50/50 dark:bg-amber-900/10 rounded-[3rem] border border-amber-100 dark:border-amber-800/20 text-center">
                                ...
                                <button className="w-full py-3 bg-amber-500 hover:bg-amber-600 text-white rounded-[3rem] font-bold text-xs uppercase tracking-widest shadow-lg shadow-amber-500/30 transition-all flex items-center justify-center gap-2">
                    ...
                    <div className="p-6 rounded-[3rem] border-2 border-dashed border-slate-200 dark:border-slate-500 text-center opacity-60 hover:opacity-100 transition-opacity cursor-pointer">
