...
const MythFactCard = ({ type, title, content }) => {
  ...
  return (
    <div className="group relative w-full max-w-sm">
      ...
      <div className="relative bg-white/40 dark:bg-slate-800/40 backdrop-blur-xl p-8 rounded-[2.5rem] border border-pink-200/50 dark:border-slate-500/20 shadow-xl space-y-6 hover:-translate-y-1 transition-all duration-500 h-full flex flex-col">
